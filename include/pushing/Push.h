...
#define NUM_INEQ_CONSTRAINTS (NUM_XVARIABLES * 2 + NUM_UVARIABLES) * (NUM_STEPS - 1) // 20 //550 // Aeq -Aeq Ades (4+4+2)*(NUM_STEPS-1)
#define NUM_EQ_CONSTRAINTS 0
#define NUM_CONSTRAINTS (NUM_XVARIABLES * 2 + NUM_UVARIABLES) * (NUM_STEPS - 1) // 20 //550
