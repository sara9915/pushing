...
int main(int argc, char *argv[])
{
    ...
    while (ros::ok())
    {
        ...
        tracker_pose_sub = nh.subscribe("/tracker_pose", 1, callback);
        ...
        Eigen::Isometry3d TTC(qTC); //homogenous matriz from camera color optical frame to base link
